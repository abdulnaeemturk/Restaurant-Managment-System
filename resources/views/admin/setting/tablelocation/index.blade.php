...
<script>
    ...
    function addRecord() {
        var action_completed = submitFormDynamically('add_form', 'admin/setting/tablelocation', 'Successfully Inserted',
    ...
    function editCurrentRecord(_record_id) {
        getFormRecordDynamically("update_form", 'admin/setting/tablelocation', _record_id, "get", "update_record",
            "add_form", "update_form");
    }

    function updateRecord(_record_id) {
        var action_completed = submitFormDynamically('update_form', 'admin/setting/tablelocation/' + _record_id,
    ...
    function deleteCurrentRecord(_record_id) {
        var action_completed = submitFormDynamically('delete_form' + _record_id, 'admin/setting/tablelocation/' +
    ...
    function fetchLatestRecordsPagination(_tablelocation_appendable = 'records_table', _page_number = 0, _appened = 0,
        _per_page = 10) {

        if (_per_page == 10) {
            _per_page = $('#records_perpage option:selected').val();
        }
        fetchRecordsDynamically(_tablelocation_appendable, 'admin/setting/tablelocationlistusingpagination', _per_page,
