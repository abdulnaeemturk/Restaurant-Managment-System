...
<!-- /. Main Sidebar Container -->
  ...
  <script src="{{ asset('assets/dist/js/toastr.min.js') }}" type="text/javascript"></script>
    ...
    function addRecord()
    {
    var action_completed = submitFormDynamically('add_form', 'admin/setting/linktableuser', 'Successfully Inserted', 'Please Try Again', 'POST');
    ...
    {
        getFormRecordDynamically("update_form", 'admin/setting/linktableuser', _record_id, "get", "update_record", "add_form", "update_form");
    }

    function updateRecord(_record_id)
    {
        var action_completed = submitFormDynamically('update_form', 'admin/setting/linktableuser/'+_record_id, 'Successfully Updated', 'Please Try Again', 'POST');
        if(action_completed == "success")
        {
    ...
    {
        var action_completed = submitFormDynamically('delete_form'+_record_id, 'admin/setting/linktableuser/'+_record_id, 'Successfully Deleted', 'Please Try Again', 'POST');
        if(action_completed == "success")
        {
        // cancelUpdateForm('add_form', 'update_form');
        fetchLatestRecordsPagination();
    ...
    function fetchLatestRecordsPagination(_linktableuser_appendable = 'records_table', _page_number = 0, _appened = 0, _per_page = 10)
    {
        ...
        fetchRecordsDynamically(_linktableuser_appendable, 'admin/setting/linktableuserlistusingpagination', _per_page, _page_number, _appened);
    }
